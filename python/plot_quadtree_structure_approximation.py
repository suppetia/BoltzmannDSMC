...
if __name__ == "__main__":
    ...
    filename = "../data/apollo_cm/cm2.png"
    # filename = "../data/vertical_line/vl1.png"
    # filename = "../data/wing1.png"
    filename = "../data/cylinder/c1_b.png"
    filename = "../data/cylinder/c3.png"
    EXPORT_DIR = "../../../../Thesis/src/graphics/plots/"
    ...
    col_rect = ax.add_collection(PatchCollection(rects, linewidth=.5, edgecolor="red", facecolor='none'))
    ...
    # print(lines)
    approx_lines = ax.add_collection(LineCollection(lines, colors="#0760e2", linewidths=3))
    if normals:
        normal_lines = ax.add_collection(LineCollection(np.array(normals)*(rescale_x/width), colors="purple", linewidths=.5))
    ...
    # fig.savefig(EXPORT_DIR+filename.split("/")[-1][:-4]+f"_quadtree_depth{depth}.eps", dpi=300, bbox_inches="tight")
    fig.savefig(EXPORT_DIR+filename.split("/")[-1][:-4]+f"_quadtree_depth{depth}.png", dpi=300, bbox_inches="tight")
